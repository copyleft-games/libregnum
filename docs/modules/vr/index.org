...
:PROPERTIES:
:CUSTOM_ID: lrgvrcomfortsettings
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgvrcontrollerbutton-flags
:END:
#+begin_src C
typedef enum {
...
:PROPERTIES:
:CUSTOM_ID: basic-vr-initialization
:END:
#+begin_src C
LrgVRService *vr;
...
:PROPERTIES:
:CUSTOM_ID: comfort-options-explained
:END:
*** Turn Modes
:PROPERTIES:
:CUSTOM_ID: turn-modes
:END:
...
*** LrgVRComfortSettings
:PROPERTIES:
:CUSTOM_ID: lrgvrcomfortsettings-1
:END:
...
:CUSTOM_ID: see-also
:END:
- [[../input/index.md][Input Module]] - General input handling
- [[../graphics/camera3d.md][Camera3D]] - 3D camera for non-VR rendering
- [[../postprocess/index.md][Post-Processing]] - Effects like comfort vignette
