...
:PROPERTIES:
:CUSTOM_ID: command-registration
:END:
*** Built-in Commands
:PROPERTIES:
...
:PROPERTIES:
:CUSTOM_ID: registering-custom-commands
:END:
#+begin_src C
static gchar *
...
:PROPERTIES:
:CUSTOM_ID: unregistering-commands
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: getting-command-info
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: synchronous-execution
:END:
#+begin_src C
...
** Output Management
:PROPERTIES:
:CUSTOM_ID: output-management
:END:
*** Printing Text
:PROPERTIES:
:CUSTOM_ID: printing-text
:END:
#+begin_src C
