...
:PROPERTIES:
:CUSTOM_ID: max-samples-per-section
:END:
#+begin_src C
...
** Clearing Data
:PROPERTIES:
:CUSTOM_ID: clearing-data
:END:
*** Clear Everything
:PROPERTIES:
:CUSTOM_ID: clear-everything
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: clear-specific-section
:END:
#+begin_src C
