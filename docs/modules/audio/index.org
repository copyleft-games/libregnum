...
** PCM mixer buses, sends, effects, and stream playback

See [[file:mixer.org][PCM mixer buses, sends, effects, and stream playback]] for the API, examples, and tested behavior.
