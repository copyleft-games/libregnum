* LrgProceduralAudio
:PROPERTIES:
:CUSTOM_ID: lrgproceduralaudio
:END:
Derivable base class for real-time procedural audio generation.

#+begin_quote
*[[../../index.md][Home]]* > *[[../index.md][Modules]]* > *[[file:index.org][Audio]]* > LrgProceduralAudio
...
** Creating a Subclass
:PROPERTIES:
:CUSTOM_ID: creating-a-subclass
:END:
*** Step 1: Define Type
:PROPERTIES:
:CUSTOM_ID: step-1-define-type
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: step-2-implement-generate
:END:
#+begin_src C
static void
my_synth_generate (LrgProceduralAudio *audio,
...
:PROPERTIES:
:CUSTOM_ID: using-with-lrgaudiomanager
:END:
...
:PROPERTIES:
:CUSTOM_ID: example-complete-synthesizer
:END:
#+begin_src C
#include <libregnum.h>
#include <math.h>
