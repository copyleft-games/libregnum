...
:PROPERTIES:
:CUSTOM_ID: custom-weapon-rendering
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: custom-ground-detection
:END:
#+begin_src C
static gboolean
...
- [[file:third-person-template.org][LrgThirdPersonTemplate]] - Third-person alternative
