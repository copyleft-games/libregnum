...
:PROPERTIES:
:CUSTOM_ID: combat-variant-slay-the-spire-style
:END:
...
:PROPERTIES:
:CUSTOM_ID: poker-variant-balatro-style
:END:
...
- [[../examples/deckbuilder.md][Deckbuilder Example]] - Complete example
