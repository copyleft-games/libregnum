...
:PROPERTIES:
:CUSTOM_ID: lapcheckpoint-tracking-2d
:END:
#+begin_src C
/* Current lap (1-based) */
...
:END:
- [[file:game-2d-template.org][LrgGame2DTemplate]] - 2D base features
- [[file:game-3d-template.org][LrgGame3DTemplate]] - 3D base features
