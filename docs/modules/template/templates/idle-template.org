...
:PROPERTIES:
:CUSTOM_ID: processing-offline-progress
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: custom-offline-handler
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: generator-management
:END:
*** Access Calculator
:PROPERTIES:
:CUSTOM_ID: access-calculator
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: custom-prestige-layer
:END:
#+begin_src C
static LrgPrestige *
...
:PROPERTIES:
:CUSTOM_ID: big-number-formatting
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: when-to-use-lrgidle2dtemplate
:END:
...
- [[file:game-2d-template.org][LrgGame2DTemplate]] - 2D template with virtual resolution
- [[../systems/engagement.md][Engagement Systems]] - Statistics and daily rewards
- [[../examples/idle-game.md][Idle Game Example]] - Complete example
