...
:PROPERTIES:
:CUSTOM_ID: lrgtemplatemainmenustate
:END:
...
:PROPERTIES:
:CUSTOM_ID: menu-item-configuration
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: adding-custom-menu-items
:END:
#+begin_src C
/* Add custom items */
...
:PROPERTIES:
:CUSTOM_ID: lrgtemplatepausemenustate
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgtemplatesettingsmenustate
:END:
...
:PROPERTIES:
:CUSTOM_ID: button-configuration
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrgtemplateloadingstate
:END:
A loading screen with progress tracking, task management, and visual feedback.
See [[file:../states/loading.org][Asset loading and failure handling]] for asset-manager integration.

*** Construction
:PROPERTIES:
:CUSTOM_ID: construction-3
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: adding-loading-tasks
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: minimum-display-time
:END:
#+begin_src C
...
:END:
- [[../../gamestate/index.md][LrgGameState]] - Base game state
- [[../../gamestate/index.md][LrgGameStateManager]] - State stack management
- [[../../settings/index.md][Settings System]] - Persisted settings
