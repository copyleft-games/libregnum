...
:PROPERTIES:
:CUSTOM_ID: implementing-lrgidlemixin
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: implementing-lrgdeckmixin
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: card-playing-example
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: checking-for-mixin-support
:END:
#+begin_src C
static void
...
:END:
- [[../templates/idle-template.md][LrgIdleTemplate]] - Idle game template
- [[../templates/deckbuilder-template.md][LrgDeckbuilderTemplate]] - Deckbuilder templates
- [[https://docs.gtk.org/gobject/concepts.html#interfaces][GObject Interfaces]] - GObject interface documentation
