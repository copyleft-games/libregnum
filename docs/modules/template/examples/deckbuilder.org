...
:PROPERTIES:
:CUSTOM_ID: key-features-demonstrated
:END:
*** Card Pile Management
:PROPERTIES:
:CUSTOM_ID: card-pile-management
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: block-and-damage-resolution
:END:
#+begin_src C
...
:END:
- [[../templates/deckbuilder-template.md][LrgDeckbuilderCombatTemplate]] - Combat variant template
- [[../systems/mixins.md][LrgDeckMixin]] - Deck management interface
- [[../systems/object-pool.md][Object Pooling]] - Pool cards for performance
