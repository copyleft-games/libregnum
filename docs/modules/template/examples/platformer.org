...
:PROPERTIES:
:CUSTOM_ID: collision-resolution
:END:
...
:END:
- [[../templates/platformer-template.md][LrgPlatformerTemplate]] - Full template reference
- [[../systems/input-buffer.md][Input Buffering]] - Input buffer system
- [[../systems/game-feel.md][Game Feel]] - Juice effects
