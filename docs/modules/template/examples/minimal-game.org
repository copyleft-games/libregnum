...
:PROPERTIES:
:CUSTOM_ID: minimal-game-example
:END:
...
** Code Breakdown
:PROPERTIES:
:CUSTOM_ID: code-breakdown
:END:
*** 1. Type Declaration
:PROPERTIES:
:CUSTOM_ID: 1-type-declaration
:END:
#+begin_src C
G_DECLARE_FINAL_TYPE (MyMinimalGame, my_minimal_game, MY, MINIMAL_GAME, LrgGameTemplate)
#+end_src
...
:PROPERTIES:
:CUSTOM_ID: 2-configure-virtual-method
:END:
...
:PROPERTIES:
:CUSTOM_ID: 3-update-virtual-method
:END:
...
:PROPERTIES:
:CUSTOM_ID: 4-draw-virtual-method
:END:
...
** Adding Features
:PROPERTIES:
:CUSTOM_ID: adding-features
:END:
*** Add a Texture
:PROPERTIES:
:CUSTOM_ID: add-a-texture
:END:
#+begin_src C
struct _MyMinimalGame
{
...
:END:
- See [[file:idle-game.org][Idle Game Example]] for idle/incremental mechanics
- See [[file:deckbuilder.org][Deckbuilder Example]] for card game mechanics
- See [[file:platformer.org][Platformer Example]] for 2D platformer mechanics

** Related Documentation
:PROPERTIES:
:CUSTOM_ID: related-documentation
:END:
- [[../templates/game-template.md][LrgGameTemplate]] - Full template reference
- [[../README.org][Getting Started]] - Template system overview
