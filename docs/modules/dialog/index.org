...
:PROPERTIES:
:CUSTOM_ID: conditions-and-effects
:END:
...
- [[file:dialog-node.org][LrgDialogNode]] - Single dialogue point with responses
- [[file:dialog-response.org][LrgDialogResponse]] - Player choice option
- [[file:dialog-tree.org][LrgDialogTree]] - Complete dialogue structure
- [[file:dialog-runner.org][LrgDialogRunner]] - Conversation flow manager
