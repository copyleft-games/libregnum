...
- *[[file:gltf-info.org][LrgGltfInfo]]* - Headless glTF/GLB inspection: raylib mesh order, node and mesh names, vertex counts, skins, animation names, Draco detection and per-node visibility masks
