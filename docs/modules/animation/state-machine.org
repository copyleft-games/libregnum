...
:PROPERTIES:
:CUSTOM_ID: animation-state-machine
:END:
...
:PROPERTIES:
:CUSTOM_ID: example-character-controller
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: transition-conditions
:END:
