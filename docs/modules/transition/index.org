...
** Transition Types
:PROPERTIES:
:CUSTOM_ID: transition-types
:END:
*** Fade Transition
:PROPERTIES:
:CUSTOM_ID: fade-transition
:END:
#+begin_src C
LrgFadeTransition *fade = lrg_fade_transition_new ();
...
:PROPERTIES:
:CUSTOM_ID: custom-shader-transition
:END:
#+begin_src C
