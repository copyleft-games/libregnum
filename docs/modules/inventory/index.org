...
:END:
*** [[file:item-def.org][LrgItemDef - Item Type Definition]]
:PROPERTIES:
...
*** [[file:inventory.org][LrgInventory - Item Container]]
:PROPERTIES:
...
*** [[file:equipment.org][LrgEquipment - Equipment Slots]]
:PROPERTIES:
:CUSTOM_ID: lrgequipment---equipment-slots
:END:
...
:PROPERTIES:
:CUSTOM_ID: virtual-functions-and-subclassing
:END:
...
:PROPERTIES:
:CUSTOM_ID: checking-inventory-space
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: moving-items-between-inventories
:END:
#+begin_src C
/* Remove from source */
...
:PROPERTIES:
:CUSTOM_ID: equipment-with-stats
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: listening-to-inventory-changes
:END:
#+begin_src C
...
:CUSTOM_ID: see-also
:END:
- [[file:item-def.org][LrgItemDef Documentation]]
- [[file:item-stack.org][LrgItemStack Documentation]]
- [[file:inventory.org][LrgInventory Documentation]]
- [[file:equipment.org][LrgEquipment Documentation]]
