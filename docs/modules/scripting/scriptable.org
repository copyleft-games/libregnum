...
:PROPERTIES:
:CUSTOM_ID: lrgscriptable-interface
:END:
...
:PROPERTIES:
:CUSTOM_ID: when-to-use-lrgscriptable
:END:
...
:PROPERTIES:
:CUSTOM_ID: defining-script-methods
:END:
#+begin_src C
#include <libregnum.h>
...
:PROPERTIES:
:CUSTOM_ID: controlling-property-access
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: interface-initialization
:END:
#+begin_src C
static void
...
** Method Descriptors
:PROPERTIES:
:CUSTOM_ID: method-descriptors
:END:
*** LrgScriptMethod Structure
:PROPERTIES:
:CUSTOM_ID: lrgscriptmethod-structure
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: method-function-signature
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_get_script_methods
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_get_property_access
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_on_script_attach
:END:
#+begin_src C
void
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_on_script_detach
:END:
#+begin_src C
void
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_find_method
:END:
#+begin_src C
const LrgScriptMethod *
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_invoke_method
:END:
#+begin_src C
gboolean
...
:PROPERTIES:
:CUSTOM_ID: lrg_scriptable_default_get_property_access
:END:
#+begin_src C
LrgScriptAccessFlags
...
:CUSTOM_ID: see-also
:END:
- [[file:index.org][Scripting Module Overview]]
- [[file:scripting.org][LrgScripting]] - Base scripting interface
