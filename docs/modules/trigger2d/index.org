...
:PROPERTIES:
:CUSTOM_ID: 2d-trigger-system-module
:END:
...
** Trigger Shapes
:PROPERTIES:
:CUSTOM_ID: trigger-shapes
:END:
*** Rectangle Trigger
:PROPERTIES:
:CUSTOM_ID: rectangle-trigger
:END:
#+begin_src C
