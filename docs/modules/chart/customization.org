...
:PROPERTIES:
:CUSTOM_ID: automatic-color-palette
:END:
...
** Margins and Layout
:PROPERTIES:
:CUSTOM_ID: margins-and-layout
:END:
*** Chart Margins
:PROPERTIES:
:CUSTOM_ID: chart-margins
:END:
#+begin_src C
...
** Axes (2D Charts)
:PROPERTIES:
:CUSTOM_ID: axes-2d-charts
:END:
*** Axis Titles
:PROPERTIES:
:CUSTOM_ID: axis-titles
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: axis-range-and-ticks
:END:
#+begin_src C
/* Fixed range */
...
:PROPERTIES:
:CUSTOM_ID: position-and-visibility
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: per-series-legend-control
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: line-and-marker-styles
:END:
*** Line Width
:PROPERTIES:
:CUSTOM_ID: line-width
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: triggering-animation
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: hover-changed-signal
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: custom-color-scales-heatmaps
:END:
*** Built-in Scales
:PROPERTIES:
:CUSTOM_ID: built-in-scales
:END:
#+begin_src C
