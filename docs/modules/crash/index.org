...
:PROPERTIES:
:CUSTOM_ID: crash-report-contents
:END:
...
:PROPERTIES:
:CUSTOM_ID: custom-crash-dialogs
:END:
...
:PROPERTIES:
:CUSTOM_ID: manual-crash-reports
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgcrashdialog-virtual-methods
:END:
| Method             | Description                    |
|--------------------+--------------------------------|
...
:PROPERTIES:
:CUSTOM_ID: integration-with-glib-logging
:END:
