...
:PROPERTIES:
:CUSTOM_ID: custom-achievement-with-unlock-logic
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: achievement-notification
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrgachievementprogress
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgachievementmanager
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgachievementnotification
:END:
...
:PROPERTIES:
:CUSTOM_ID: notification-positions
:END:
#+begin_src C
typedef enum {
...
:PROPERTIES:
:CUSTOM_ID: save-system-integration
:END:
