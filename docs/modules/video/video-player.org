...
:PROPERTIES:
:CUSTOM_ID: position-and-duration
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-basic-playback
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-looping-background-video
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-video-with-subtitles
:END:
#+begin_src C
g_autoptr(LrgVideoPlayer) player = lrg_video_player_new ();
...
:PROPERTIES:
:CUSTOM_ID: example-seek-and-progress
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-playback-rate
:END:
#+begin_src C
/* Slow motion */
