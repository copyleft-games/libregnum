...
- *[[file:wall-set.org][LrgWallSet]]*: Static XZ box collision world for authoritative servers (swept square agents, wall sliding, line of sight, camera raycasts, interior volumes, grid broadphase)
...
- =src/physics/lrg-wall-set.h= - Static XZ box collision (=LrgWallSet=, =LrgWall=)
...
- [[file:wall-set.org][LrgWallSet Documentation]]
