...
:PROPERTIES:
:CUSTOM_ID: accessing-collision-data
:END:
*** Colliding Bodies
:PROPERTIES:
:CUSTOM_ID: colliding-bodies
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: usage-in-collision-handlers
:END:
*** Direct Callback
:PROPERTIES:
:CUSTOM_ID: direct-callback
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: in-physics-simulation
:END:
#+begin_src C
static void
