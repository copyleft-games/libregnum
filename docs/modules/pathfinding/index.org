...
** Triangle mesh baking, projection, and A* navigation

See [[file:nav-mesh.org][Triangle mesh baking, projection, and A* navigation]] for the API, examples, and tested behavior.
