...
:PROPERTIES:
:CUSTOM_ID: lrgsaveable---saveable-interface
:END:
...
** Public Functions
:PROPERTIES:
:CUSTOM_ID: public-functions
:END:
*** lrg_saveable_get_save_id()
:PROPERTIES:
:CUSTOM_ID: lrg_saveable_get_save_id
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: implementation-example
:END:
#+begin_src C
#include <libregnum.h>
...
:PROPERTIES:
:CUSTOM_ID: registration-and-usage
:END:
#+begin_src C
/* Create object */
