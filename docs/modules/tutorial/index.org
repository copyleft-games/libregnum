...
:PROPERTIES:
:CUSTOM_ID: tutorial-system-module
:END:
...
** Tutorial Steps
:PROPERTIES:
:CUSTOM_ID: tutorial-steps
:END:
*** Step Types
:PROPERTIES:
:CUSTOM_ID: step-types
:END:
| Type        | Description                |
|-------------+----------------------------|
...
:PROPERTIES:
:CUSTOM_ID: progress-persistence
:END:
