...
:PROPERTIES:
:CUSTOM_ID: enableddisabled-state
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: widget-state-management
:END:
#+begin_src C
typedef struct
{
...
:PROPERTIES:
:CUSTOM_ID: hit-test-and-interaction
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: widget-visibility-toggle
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: measuring-widget-tree
:END:
#+begin_src C
...
:CUSTOM_ID: related
:END:
- [[file:container.org][Container]] - Container widgets
- [[file:ui-event.org][UI Events]] - Event system
