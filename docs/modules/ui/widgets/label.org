...
:PROPERTIES:
:CUSTOM_ID: using-themes-default-font-recommended
:END:
...
:PROPERTIES:
:CUSTOM_ID: using-a-specific-font
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-dynamic-text-updates
:END:
#+begin_src C
...
- [[../theme.md][Theme]] - Theming system and default font
