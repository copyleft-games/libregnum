...
** Locale Management
:PROPERTIES:
:CUSTOM_ID: locale-management
:END:
*** Add Locales
:PROPERTIES:
:CUSTOM_ID: add-locales
:END:
#+begin_src C
...
** Current Locale
:PROPERTIES:
:CUSTOM_ID: current-locale
:END:
*** Set Current Locale
:PROPERTIES:
:CUSTOM_ID: set-current-locale
:END:
#+begin_src C
...
** String Lookup
:PROPERTIES:
:CUSTOM_ID: string-lookup
:END:
*** Basic Lookup
:PROPERTIES:
:CUSTOM_ID: basic-lookup
:END:
#+begin_src C
LrgLocalization *loc = lrg_localization_get_default();
...
:PROPERTIES:
:CUSTOM_ID: example-complete-setup
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-using-localization-in-code
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: example-language-selection
:END:
#+begin_src C
...
:CUSTOM_ID: see-also
:END:
- [[file:locale.org][LrgLocale]] - Individual language translations
