...
- *[[file:timer-manager.org][LrgTimerManager]]* - Frame-driven gameplay and unscaled timers

- *[[file:random-stream.org][LrgRandomStream]]* - Independent deterministic random streams with portable snapshots

- *[[file:reset-schedule.org][LrgResetSchedule]]* - Deterministic daily and weekly reset periods for repeatable content
