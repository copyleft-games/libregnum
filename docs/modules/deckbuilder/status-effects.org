...
:PROPERTIES:
:CUSTOM_ID: lrgstatuseffectinstance
:END:
...
:PROPERTIES:
:CUSTOM_ID: lrgstatuseffectregistry
:END:
...
:PROPERTIES:
:CUSTOM_ID: creating-custom-status-effects
:END:
#+begin_src C
