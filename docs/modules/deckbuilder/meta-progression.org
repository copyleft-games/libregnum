...
:PROPERTIES:
:CUSTOM_ID: custom-unlock-conditions
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: ascension-effects-by-level
:END:
| Level | Effect                            |
|-------+-----------------------------------|
...
:PROPERTIES:
:CUSTOM_ID: lrgdeckbuildermanager
:END:
...
:CUSTOM_ID: see-also
:END:
- [[file:modding.org#custom-characters][Characters and Unlocks]]
