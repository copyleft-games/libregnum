...
:PROPERTIES:
:CUSTOM_ID: keyword-descriptions
:END:
| Keyword      | Effect                                                            |
|--------------+-------------------------------------------------------------------|
...
:PROPERTIES:
:CUSTOM_ID: creating-custom-keywords
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrgcardkeywordregistry
:END:
