...
:PROPERTIES:
:CUSTOM_ID: creating-deck-definitions
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: drawing-and-shuffling
:END:
#+begin_src C
/* Draw cards */
void
...
:PROPERTIES:
:CUSTOM_ID: card-addition-during-run
:END:
#+begin_src C
