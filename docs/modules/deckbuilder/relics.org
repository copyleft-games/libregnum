...
** Built-in Relics
:PROPERTIES:
:CUSTOM_ID: built-in-relics
:END:
*** Burning Blood
:PROPERTIES:
:CUSTOM_ID: burning-blood
:END:
#+begin_src C
...
** Built-in Potions
:PROPERTIES:
:CUSTOM_ID: built-in-potions
:END:
*** Health Potion
:PROPERTIES:
:CUSTOM_ID: health-potion
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: creating-custom-relics
:END:
#+begin_src C
...
** YAML Definitions
:PROPERTIES:
:CUSTOM_ID: yaml-definitions
:END:
*** Relic YAML
:PROPERTIES:
:CUSTOM_ID: relic-yaml
:END:
#+begin_src yaml
type: relic-def
id: "burning-blood"
