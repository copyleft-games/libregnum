...
:PROPERTIES:
:CUSTOM_ID: lrgcardeffectexecutor
:END:
...
:PROPERTIES:
:CUSTOM_ID: creating-custom-executors
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: lrgcardeffectregistry
:END:
...
:PROPERTIES:
:CUSTOM_ID: subscribing-to-events
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: effect-execution-flow
:END:
1. Card is played
