...
:PROPERTIES:
:CUSTOM_ID: lrgdemogatable-interface
:END:
...
:PROPERTIES:
:CUSTOM_ID: implementing-lrgdemogatable
:END:
#+begin_src C
/* In your level class */
static const gchar *
...
:PROPERTIES:
:CUSTOM_ID: demo-save-management
:END:
#+begin_src C
void
...
:PROPERTIES:
:CUSTOM_ID: upgrade-detection-with-steam
:END:
#+begin_src C
static gboolean
...
:CUSTOM_ID: see-also
:END:
- [[../save/index.md][Save System]] - For demo save management
- [[../steam/index.md][Steam Module]] - For Steam-based upgrade detection
- [[../ui/index.md][UI Module]] - For demo UI elements
