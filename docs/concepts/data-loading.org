...
:PROPERTIES:
:CUSTOM_ID: data-loading-with-yaml
:END:
...
#+begin_quote
*[[../../index.md][Home]]* > *[[file:index.org][Concepts]]* > Data Loading
...
:PROPERTIES:
:CUSTOM_ID: creating-a-dataloader
:END:
...
:PROPERTIES:
:CUSTOM_ID: loading-single-files
:END:
*** Synchronous Loading
:PROPERTIES:
:CUSTOM_ID: synchronous-loading
:END:
...
:PROPERTIES:
:CUSTOM_ID: type-specific-loading
:END:
...
:PROPERTIES:
:CUSTOM_ID: asynchronous-loading
:END:
*** Basic Async
:PROPERTIES:
:CUSTOM_ID: basic-async
:END:
...
** Practical Examples
:PROPERTIES:
:CUSTOM_ID: practical-examples
:END:
*** Entity Definition
:PROPERTIES:
:CUSTOM_ID: entity-definition
:END:
#+begin_src yaml
...
:CUSTOM_ID: see-also
:END:
- [[../modules/core/data-loader.md][LrgDataLoader Documentation]] - Full API
- [[file:type-registry.org][Type Registry]] - Registry deep dive
- [[../modules/core/asset-manager.md][Asset Management]] - Asset loading
