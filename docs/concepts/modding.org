...
#+begin_quote
*[[../../index.md][Home]]* > *[[file:index.org][Concepts]]* > Modding
...
** Mod Structure
:PROPERTIES:
:CUSTOM_ID: mod-structure
:END:
*** Minimal Mod
:PROPERTIES:
:CUSTOM_ID: minimal-mod
:END:
#+begin_example
my-mod/
├── mod.yaml
...
:PROPERTIES:
:CUSTOM_ID: circular-dependency-detection
:END:
...
:PROPERTIES:
:CUSTOM_ID: mod-priority-and-overrides
:END:
...
:PROPERTIES:
:CUSTOM_ID: complete-mod-example
:END:
#+begin_example
awesome-mod/
├── mod.yaml
...
:CUSTOM_ID: see-also
:END:
- [[../modules/mod/index.md][Mod System Documentation]] /(Phase 4)/
- [[../modules/core/asset-manager.md][Asset Manager]] - Asset overlay
- [[file:type-registry.org][Type Registry]] - Type override
- [[../architecture.md][Architecture Overview]] - Extension patterns
