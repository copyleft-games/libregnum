...
:PROPERTIES:
:CUSTOM_ID: hello-world---getting-started-with-libregnum
:END:
...
:PROPERTIES:
:CUSTOM_ID: adding-debug-overlay
:END:
...
:PROPERTIES:
:CUSTOM_ID: adding-debug-console
:END:
...
:PROPERTIES:
:CUSTOM_ID: building-the-example
:END:
Create a =Makefile=:
