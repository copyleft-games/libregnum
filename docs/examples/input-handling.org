...
:PROPERTIES:
:CUSTOM_ID: input-handling-example
:END:
...
:PROPERTIES:
:CUSTOM_ID: creating-input-actions
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: loadingsaving-controls
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: control-remapping-menu
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: yaml-configuration-example
:END:
#+begin_src yaml
actions:
  - name: jump
...
:PROPERTIES:
:CUSTOM_ID: complete-game-loop-example
:END:
#+begin_src C
int main(void)
{
...
:END:
- See [[../modules/input/index.md][Input Module Overview]] for more details
- See [[file:ui-basics.org][UI Basics Example]] for UI integration
