...
:PROPERTIES:
:CUSTOM_ID: example-interactive-dialog
:END:
#+begin_src C
typedef struct
{
...
** Common UI Patterns
:PROPERTIES:
:CUSTOM_ID: common-ui-patterns
:END:
*** Menu with List
:PROPERTIES:
:CUSTOM_ID: menu-with-list
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: complete-main-function
:END:
#+begin_src C
int main(void)
{
...
:PROPERTIES:
:CUSTOM_ID: key-concepts-demonstrated
:END:
...
:END:
- See [[../modules/ui/index.md][UI Module Overview]] for complete documentation
- See [[file:input-handling.org][Input Handling Example]] for input integration
- See [[../modules/ui/widget.md][Widget Documentation]] for widget details
