...
:PROPERTIES:
:CUSTOM_ID: building-a-dialog-tree
:END:
#+begin_src C
/* Create the tree */
...
:PROPERTIES:
:CUSTOM_ID: running-dialog-in-game-loop
:END:
#+begin_src C
/* Start the dialogue */
...
:PROPERTIES:
:CUSTOM_ID: complex-conditions-example
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: handling-conditions-and-effects
:END:
