...
:PROPERTIES:
:CUSTOM_ID: simple-custom-widget
:END:
*** Step 1: Define the Widget
:PROPERTIES:
:CUSTOM_ID: step-1-define-the-widget
:END:
#+begin_src C
/* my-progress-bar.h */
#pragma once
...
:PROPERTIES:
:CUSTOM_ID: step-2-implement-the-widget
:END:
#+begin_src C
/* my-progress-bar.c */
...
:PROPERTIES:
:CUSTOM_ID: custom-container-widget
:END:
...
:PROPERTIES:
:CUSTOM_ID: using-custom-widgets
:END:
#+begin_src C
...
:CUSTOM_ID: see-also
:END:
- [[../modules/ui/index.md][UI Module Documentation]]
- [[file:implementing-saveable.org][Implementing Saveable]]
- [[../modules/ui/theming.md][Theme System]]
