...
:PROPERTIES:
:CUSTOM_ID: how-to-implement-the-saveable-interface
:END:
...
:PROPERTIES:
:CUSTOM_ID: saveable-interface-overview
:END:
...
:PROPERTIES:
:CUSTOM_ID: implementing-saveable
:END:
*** Step 1: Add Interface to Class Definition
:PROPERTIES:
:CUSTOM_ID: step-1-add-interface-to-class-definition
:END:
#+begin_src C
/* my-character.h */
#pragma once
...
:PROPERTIES:
:CUSTOM_ID: step-2-implement-interface-methods
:END:
#+begin_src C
/* my-character.c */
...
:PROPERTIES:
:CUSTOM_ID: handling-complex-types
:END:
...
:PROPERTIES:
:CUSTOM_ID: using-saveable-in-game
:END:
#+begin_src C
/* Save game */
...
:PROPERTIES:
:CUSTOM_ID: example-complete-saveable-implementation
:END:
#+begin_src C
...
:CUSTOM_ID: see-also
:END:
- [[../modules/save/index.md][Save System Documentation]]
- [[../modules/data/serialization.md][Data Types and Serialization]]
