...
:PROPERTIES:
:CUSTOM_ID: how-to-create-custom-ecs-components
:END:
...
:PROPERTIES:
:CUSTOM_ID: creating-a-simple-component
:END:
*** Step 1: Define the Component Class
:PROPERTIES:
:CUSTOM_ID: step-1-define-the-component-class
:END:
...
:PROPERTIES:
:CUSTOM_ID: step-2-implement-the-component
:END:
...
:PROPERTIES:
:CUSTOM_ID: component-with-state-machine
:END:
...
:PROPERTIES:
:CUSTOM_ID: component-interaction
:END:
...
:PROPERTIES:
:CUSTOM_ID: component-communication
:END:
...
:CUSTOM_ID: see-also
:END:
- [[../modules/ecs/index.md][ECS Module Documentation]]
- [[file:implementing-saveable.org][Implementing Saveable for Persistence]]
