...
:PROPERTIES:
:CUSTOM_ID: scene-module-tutorial
:END:
...
:PROPERTIES:
:CUSTOM_ID: part-1-creating-a-scene-in-blender
:END:
*** Step 1: Set Up Your Scene
:PROPERTIES:
:CUSTOM_ID: step-1-set-up-your-scene
:END:
...
:PROPERTIES:
:CUSTOM_ID: step-2-assign-materials
:END:
1. Select the pole
...
:PROPERTIES:
:CUSTOM_ID: step-3-export-to-yaml
:END:
...
:PROPERTIES:
:CUSTOM_ID: part-2-loading-the-scene-in-c
:END:
...
:PROPERTIES:
:CUSTOM_ID: step-1-basic-scene-loading
:END:
#+begin_src C
#include <libregnum.h>
#include <glib.h>
...
:PROPERTIES:
:CUSTOM_ID: step-2-iterating-entities-and-objects
:END:
#+begin_src C
static void
...
:PROPERTIES:
:CUSTOM_ID: step-3-finding-specific-objects
:END:
#+begin_src C
/* Get entity by name */
...
:PROPERTIES:
:CUSTOM_ID: part-3-rendering-scene-objects
:END:
*** Step 1: Converting to Renderable Shapes
:PROPERTIES:
:CUSTOM_ID: step-1-converting-to-renderable-shapes
:END:
...
:PROPERTIES:
:CUSTOM_ID: step-2-full-render-loop
:END:
#+begin_src C
#include <libregnum.h>
#include <graylib.h>
...
:PROPERTIES:
:CUSTOM_ID: part-4-modifying-and-saving-scenes
:END:
*** Step 1: Modifying Scene Data
:PROPERTIES:
:CUSTOM_ID: step-1-modifying-scene-data
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: step-2-adding-new-objects
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: step-3-creating-new-entities
:END:
#+begin_src C
/* Create a new entity */
...
:PROPERTIES:
:CUSTOM_ID: step-4-saving-the-modified-scene
:END:
#+begin_src C
...
:PROPERTIES:
:CUSTOM_ID: part-5-complete-example-application
:END:
...
:PROPERTIES:
:CUSTOM_ID: objects-not-appearing
:END:
...
:PROPERTIES:
:CUSTOM_ID: round-trip-precision-loss
:END:
...
:END:
- Explore the [[file:api-reference.org][API Reference]] for complete API details
- See [[file:primitives.org][Primitives]] for all supported shapes
- Check [[file:yaml-format.org][YAML Format]] for format specification
