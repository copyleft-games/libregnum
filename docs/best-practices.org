...
:PROPERTIES:
:CUSTOM_ID: best-practices-for-libregnum-games
:END:
...
:PROPERTIES:
:CUSTOM_ID: ascii-art-for-spatial-layouts
:END:
...
:PROPERTIES:
:CUSTOM_ID: property-based-auto-parsing
:END:
...
:PROPERTIES:
:CUSTOM_ID: yaml-data-organization
:END:
*Prefer Simple Types*
...
** GObject Integration
:PROPERTIES:
:CUSTOM_ID: gobject-integration
:END:
*** Property Registration
:PROPERTIES:
:CUSTOM_ID: property-registration
:END:
...
:PROPERTIES:
:CUSTOM_ID: forward-declarations
:END:
...
:PROPERTIES:
:CUSTOM_ID: type-registration-for-yaml
:END:
...
:PROPERTIES:
:CUSTOM_ID: consistent-type-structure
:END:
...
** Pitfalls to Avoid
:PROPERTIES:
:CUSTOM_ID: pitfalls-to-avoid
:END:
*** Silent YAML Deserialization Failures
:PROPERTIES:
:CUSTOM_ID: silent-yaml-deserialization-failures
:END:
...
:PROPERTIES:
:CUSTOM_ID: missing-property-registration
:END:
...
:PROPERTIES:
:CUSTOM_ID: complex-yaml-structures
:END:
...
:PROPERTIES:
:CUSTOM_ID: forgetting-forward-declarations
:END:
...
** 3D Mesh Handling
:PROPERTIES:
:CUSTOM_ID: 3d-mesh-handling
:END:
*** Coordinate System Conversions and Face Winding
:PROPERTIES:
:CUSTOM_ID: coordinate-system-conversions-and-face-winding
:END:
...
:PROPERTIES:
:CUSTOM_ID: memory-management-with-grlmodel-and-grlmesh
:END:
...
:PROPERTIES:
:CUSTOM_ID: debugging-blank-or-incorrect-renders
:END:
...
:PROPERTIES:
:CUSTOM_ID: hierarchical-entity-transforms
:END:
...
:PROPERTIES:
:CUSTOM_ID: the-solution-matrix-stack
:END:
