...
/**
 * lrg_reel_clip_get_effect:
 * @self: an #LrgReelClip
 * @index: position in the clip's effect chain
 *
 * Gets one effect of the clip's chain.
 *
 * Returns: (transfer none) (nullable): the effect at @index, or %NULL when
